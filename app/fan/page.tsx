...
// Cinematic gateway: video plays → ring materialises → match cards appear.
// Identical card layout and interaction to referee/page.tsx.
// Only differences: video source, perspective="fan", green breadcrumb accent.
...
// ─── Match catalogue (identical to referee) ────────────────────────────────────
const MATCHES: {
  id: string;
  chapterTitle: string;
  featured: boolean;
...
// ─── Fan World ─────────────────────────────────────────────────────────────────
function FanWorld({ onSelect, onBack }: {
  ...
  return (
    ...
    >
      ...
      >
        <source src="/videos/fan-world.mp4" type="video/mp4" />
      </video>
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ color: "rgba(126,207,160,0.65)" }}>SELECT MATCH</span>
        </div>
      </motion.div>
    </div>
  );
  ...
  return (
    ...
    >
      <svg width="200" height="200" viewBox="0 0 200 200" style={{ overflow: "visible" }}>
        ...
        >
          <circle cx="100" cy="100" r="96" fill="none"
            stroke="rgba(126,207,160,0.35)" strokeWidth="0.8"
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at center, rgba(126,207,160,0.05) 0%, transparent 65%)",
        filter: "blur(16px)",
      }} />
    </motion.div>
  );
...
// ─── Match Card (identical to referee) ────────────────────────────────────────
  ...
  return (
    ...
    >
      <div style={{
        ...
        <div style={{
          display: "flex", alignItems: "center", gap: 12, flex: 1, paddingBottom: 2,
        }}>
        ...
        <div style={{
          height: "0.5px",
          background: isHovered ? "rgba(110,155,255,0.35)" : "rgba(255,255,255,0.07)",
